function ciscocliStream(readStream, writeStream, options) {
	var self = this;
...
ciscocliStream.prototype.set = function Set(key, value) {
	this._dictionary[key] = value;
}

ciscocliStream.prototype.get = function Get(key) {
	return this._dictionary[key];
}

ciscocliStream.prototype.send = function(data, callback, remaining) {
	try {
...
ciscocliStream.prototype.expect = function(pattern, callback, remaining, customTimeout) {
	var self = this;
	var timeoutId = null;
...
ciscocliStream.prototype.respond = function(pattern, data, callback, remaining, customTimeout) {
	var self = this;
...
ciscocliStream.prototype.match = function(pattern, callback, remaining, customTimeout) {
	var self = this;
	var timeoutId = null;
	var timeoutMs = customTimeout || self._defaultTimeout;
	var output = "" + remaining || '';
...
ciscocliStream.prototype.between = function(startPattern, endPattern, callback, remaining, customTimeout) {
	var self = this;
	var timeoutId = null;
	var timeoutMs = customTimeout || self._defaultTimeout;
	var output = "" + remaining || '';
...
ciscocliStream.prototype.sync = function Sync(remaining) {
	var self = this;
	var _stack = [];
...
module.exports.createciscocliStream = function createciscocliStream(readStream, writeStream, options) {
	return new ciscocliStream(readStream, writeStream, options);
}

module.exports.ciscocliStream = ciscocliStream;
